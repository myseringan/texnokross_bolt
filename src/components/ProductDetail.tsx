          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 p-6 sm:p-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-xl">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">{t.productDetail.specifications}</h3>
              ...
              <div className="mt-auto">
                <div className="mb-4 sm:mb-6">
                  <div className="text-xs sm:text-sm text-blue-200/60 mb-2">{t.productDetail.price}</div>
